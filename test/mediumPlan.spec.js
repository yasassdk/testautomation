...
const { MediumPlan } = require("../pages/header/mediumPlanPage");
...
describe('Basic Plan', function() {
    ...
    /*it('TC_104 Checking for the no of products 30 - Product 1', function() {
        ...
        element(by.css("[for='someSwitchOption100'] [101']")).click();
    ...
    /*it('TC_001 User should be able to add user29', async () => {
   ...
   it('TC_020 User should be able to add user20', async () => {
    ...
    it('TC_029 Should be able to add admin users', async () => {
        ...
        element(by.css("[name='email']")).sendKeys("qatest30ta11@mailinator.com");
        element(by.css("[name='mobileNo']")).sendKeys("(141) 438-0056");
     ...
     it('TC_029 Check if the no of users to exceed FO users', async () => {
        element(by.xpath("//span[contains(.,'User Management')]")).click();
        element(by.css('.fa-plus')).click();
        element(by.css("[name='fName']")).sendKeys("Francisci");
        element(by.css("[name='lName']")).sendKeys("Blakeno");
        element(by.css("[name='email']")).sendKeys("qatest30fO51@mailinator.com");
        element(by.css("[name='userType'] [value='2: FieldOfficer']")).click();
        element(by.css(".permission-group-items > div:nth-of-type(1) .permission-checkbox")).click();  
        element(by.css("[value='8']")).click(); 
        element(by.css("[value='10']")).click();
        element(by.css(".permission-group-items > div:nth-of-type(4) .permission-checkbox")).click();
        element(by.css(".permission-group-items > div:nth-of-type(5) .permission-checkbox")).click();
        element(by.css("[value='23']")).click();
        element(by.css("[value='29']")).click();
        await mediumPlan.enterEmail("+1-202-555-0134")
        await userManagement.clickAddUser();
        await common.validateToast("Success!")  
        browser.sleep(4000);
    })
    ...
    /*it('TC_029 Check if the no of users to exceed FO users', async () => {
        element(by.xpath("//span[contains(.,'User Management')]")).click();
        element(by.css('.fa-plus')).click();
        element(by.css("[name='fName']")).sendKeys("Francisco");
        element(by.css("[name='lName']")).sendKeys("Blaken");
        element(by.css("[name='email']")).sendKeys("qatest30fO50@mailinator.com");
        element(by.css("[name='userType'] [value='2: FieldOfficer']")).click();
        element(by.css(".permission-group-items > div:nth-of-type(1) .permission-checkbox")).click();  
        element(by.css("[value='8']")).click(); 
        element(by.css("[value='10']")).click();
        ...
        element(by.css("[value='23']")).click();
        element(by.css("[value='29']")).click();
        await mediumPlan.enterEmail("+18005556677")
        await userManagement.clickAddUser();
        await common.validateToast("Success!")  
        browser.sleep(4000);
    })
    ...
    it('TC_041 Acess to Insights - Traceability data', function() {
        element(by.xpath("//span[@class='mr-2']")).click();
        element(by.css("[href='https://qa.insights.tracified.com/']")).click(); 
